export namespace smart {
  export const recipeClosedResponse = 'https://w3id.org/xapi/smart/activity/recipe/closed_response';
  export const recipeOpenAnswer = 'https://w3id.org/xapi/smart/activity/recipe/open_answer';
